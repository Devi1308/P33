 ...
 //yayimg=loadAnimation("yay.png");
  ...
  function draw() {
    ...
    if(gameState==="hug"){
      ...
      next2 = createSprite(900,750,300,100);
    ...
    // }
      next3 = createSprite(900,100,300,100);     
      next3.addImage(nextImg);
      next3.scale= 0.5;

     hide=createSprite(900,800,100,200);
     hide.shapeColor="white";
     ...
     text("next ",900,860);
      ...
      if(frameCount%5===0){
        snow.push(new Snow(Math.round(random(50,950)),10,10))
      }
    ...
    if(gameState === "end"){
      thanks=createSprite(width/2, height/2, 50, 50);
      thanks.addAnimation("background1",endImg);
      thanks.scale=1.2;
